...
class wenshan_ggzy:
    def __init__(self):
        self.url_list = [
            'https://zc.hljsjtjt.com/api/portal/bidnotice/list?_=1680487363145&keyName=&menuCode=&methodType=&pType=&pubtime=&typeCode=&page={}&pageSize=10', #招标公告
                    ]
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail:
                title = li["title"]
                date_Today = li["pubtime"].split(' ')[0]
                id = li["id"]
                url = f'https://zc.hljsjtjt.com/api/portal/details/{id}?_=1680487582022'
    ...
    def parse_detile(self, title, url, date,id):
        ...
        detail = url_html["data"]["content"]
        index_url=f'https://zc.hljsjtjt.com/#/details.html?businessId={id}&activeId=3'
