...
class wenshan_ggzy:
    def __init__(self):
        self.url_list = [
            'http://zjpubservice.zjzwfw.gov.cn/inteligentsearch/rest/inteligentSearch/getFullTextData', #招标公告
                    ]
    ...
    def parse(self):
        ...
        pn=0
        while True:
            data = {"token": "", "pn": pn, "rn": 12, "sdt": "", "edt": "", "wd": "", "inc_wd": "", "exc_wd": "",
                    ...
                    "condition": [{"fieldName": "categorynum", "isLike": True, "likeType": 2, "equal": "002001001"},
                                  {"fieldName": "infoc", "isLike": True, "likeType": 2, "equal": "33"}], "time": [
                    {"fieldName": "webdate", "startTime": "2023-03-25 00:00:00", "endTime": "2023-03-28 23:59:59"}],
                    "highlights": "", "statistics": "", "unionCondition": "", "accuracy": "", "noParticiple": "0",
            ...
            for li in detail:
                ...
                href = li["linkurl"]
                url = f'http://zjpubservice.zjzwfw.gov.cn{href}'
