...
class wenshan_ggzy:
    def __init__(self):
        self.url_list = [
            'https://www.etu365.com/api/v1/ztb/listzbggscreen_new?iszb=&gglx=0&pageSize=10&page={}', #招标公告
                    ]
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail:
                title = li["bdmc"]
                date_Today = li["ggrq_begin"].split('T')[0]
                id = li["id"]
                url = f'https://www.etu365.com:8101/ProjectMgr/ZBGGPdf?ggid={id}&_={timep}'
