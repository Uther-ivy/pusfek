...
class wenshan_ggzy:
    def __init__(self):
        self.url_list = [
            'http://www.xamggzyjyzx.org.cn/jyxx/001001/001001001/001001001001/{}.html', #招标公告
                    ]
        self.url1='http://www.xamggzyjyzx.org.cn/jyxx/001001/001001001/001001001001/list2.html'
    ...
    def parse(self):
        ...
        while True:
            ...
            # print(11, text)
            # time.sleep(6666)
            detail = html.xpath('//ul[@class="news-items"]/li')
            for li in detail:
                title = li.xpath('./a/@title')[0]
                date_Today = li.xpath('./span/text()')[0]
                href = li.xpath('./a/@href')[0]
                url = 'http://www.xamggzyjyzx.org.cn' + href
