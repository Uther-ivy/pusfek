...
class wenshan_ggzy:
    def __init__(self):
        self.url_list = [
            'https://www.caiyunzhaobiao.com/ytcms/category/bulletinList.html?dates=300&categoryId=2&tabName=%E6%8B%9B%E6%A0%87%E5%85%AC%E5%91%8A&tenderMethod=00&page={}', #招标公告
                    ]
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail:
                ...
                date_Today = li.xpath('./a/ul/li[3]/span/text()')[0]
