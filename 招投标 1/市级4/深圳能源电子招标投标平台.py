...
class wenshan_ggzy:
    def __init__(self):
        self.url_list = [
            'https://zb.sec.com.cn/zbgg/index_{}.jhtml', #招标公告
                    ]
        ...
        self.headers={'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36',
         ...
         'Cookie': 'JSESSIONID=zh_CN; clientlanguage=zh_CN; JSESSIONID=zh_CN',
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail[1:]:
                ...
                date_Today = li.xpath('./p/span[1]/text()')[0].split(' ')[0].replace('发布时间：', '')
                href = li.xpath('./a/@href')[0]
                url = 'https://zb.sec.com.cn' + href
