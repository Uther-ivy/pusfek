...
class wenshan_ggzy:
    def __init__(self):
        self.url_list = [
            'http://ggzy.lyg.gov.cn/lygweb/jyxx/001001/{}.html', #招标公告
                    ]
        self.url1='http://ggzy.lyg.gov.cn/lygweb/jyxx/001001/tradeInfo.html'
    ...
    def parse(self):
        ...
        while True:
            ...
            # print(11, text)
            # time.sleep(6666)
            detail = html.xpath('//table[@class="ewb-trade-tb"]/tbody/tr')
            for li in detail:
                title = li.xpath('./td[2]/a/@title')[0]
                date_Today = li.xpath('./td[4]/text()')[0].split(' ')[0]
                href = li.xpath('./td[2]/a/@href')[0]
                url = 'http://ggzy.lyg.gov.cn' + href
