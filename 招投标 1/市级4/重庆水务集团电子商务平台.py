...
class wenshan_ggzy:
    def __init__(self):
        self.url_list = [
            'https://www.cqswjt.cn/cms/channel/xmgg1gc/index.htm?pageNo={}', #工程招标
            'https://www.cqswjt.cn/cms/channel/xmgg1hw/index.htm?pageNo={}',#货物招标
            'https://www.cqswjt.cn/cms/channel/xmgg1fw/index.htm?pageNo={}']#服务招标
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail:
                ...
                date_Today = li.xpath('./a/span[3]/text()')[0]
                href = li.xpath('./a/@href')[0]
                url = 'https://www.cqswjt.cn' + href
