...
class wenshan_ggzy:
    def __init__(self):
        self.url_list = [
            'http://www.wtjypt.com/trade/website/page/findZBInfo', #招标公告
                    ]
    ...
    def parse(self):
        ...
        while True:
            page += 1
            data={"tenderNature":"","infoType":"","publishTimeType":"","provice":"","searchMsg":"","pageSize":10,"pageCurrent":page,"publishOrderBy":"down","bidOpenOrderBy":""}
            ...
            for li in detail:
                ...
                url = "http://www.wtjypt.com/trade/website/page/findInfoDetail"
                # print(title, url, date_Today)
                # time.sleep(666)
                # self.parse_detile(title, url, date_Today,noticeId,infoType)
    ...
    def parse_detile(self, title, url, date,noticeId,infoType):
        print(url)
        data2 = {'notid': noticeId,
                 'type': infoType}
        ...
        index_url=f'http://www.wtjypt.com/trade/website/pages/article/ggarticle.html?notid={noticeId}&type={infoType}'
