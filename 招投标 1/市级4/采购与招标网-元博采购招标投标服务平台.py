...
class wenshan_ggzy:
    def __init__(self):
        self.url_list = [
            'https://www.chinabidding.cn/zbxx/zbgg/{}.html', #招标公告
            'https://www.chinabidding.cn/zbxx/zbgs/{}.html', #中标公示
            'https://www.chinabidding.cn/zbxx/zhongbgg/{}.html', #中标公告
                    ]
    ...
    def parse(self):
        ...
        while True:
            ...
            # print(11, text)
            # time.sleep(6666)
            detail = html.xpath('//tr[@class="yj_nei"]')
            for li in detail:
                title = li.xpath('./td[1]/a/@title')[0]
                date_Today = li.xpath('./td[4]/text()')[0]
                href = li.xpath('./td[1]/a/@href')[0]
                url = 'https://www.chinabidding.cn' + href
    ...
    def parse_detile(self, title, url, date):
        ...
        item['resource'] = '采购与招标网-元博采购招标投标服务平台'
        item['shi'] = 6507
        item['sheng'] = 6500
        item['removal'] = title
        # print(item)
