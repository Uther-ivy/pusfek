...
class wenshan_ggzy:
    def __init__(self):
        self.url_list = [
            'http://hnztbkhd.fgw.henan.gov.cn/xxfbcms/search/bulletin.html?dates=300&categoryId=88&page={}&showStatus=1', #招标公告
                    ]
    ...
    def parse_detile(self, title, url, date):
        ...
        pdf='http://hnztbkhd.fgw.henan.gov.cn/resource/site_2//ceb/js/pdfjs-dist/web/viewer.html?file='+f'http://222.143.32.113:8087/bulletin/getBulletin/f50ceb51bb8246fbae2920d519997c70/{index}'
        item = {}
