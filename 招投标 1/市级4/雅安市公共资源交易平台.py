...
class baoshan_ggzy:
    def __init__(self):
        self.url_list = [
            'https://www.yaggzy.org.cn/jyxx/jsgcZbgg?area=001'
                         ]
    ...
    def parse(self):
        ...
        while True:
            ...
            # print(11, text)
            # time.sleep(6666)
            detail = html_.xpath('//div[@class="content fr content_right pull-right"]/ul/li[3]//tr')
            # if len(detail) == 0:
            ...
            for li in detail[1:]:
                ...
                url = 'https://www.yaggzy.org.cn' + href
    ...
    def parse_detile(self, title, url, date):
        ...
        detail = url_html.xpath('//div[@class="nr"]')[0]
        detail_html = etree.tostring(detail, method='HTML')
        detail_html = html.unescape(detail_html.decode())
        detail_text = url_html.xpath('string(//div[@class="nr"])').replace('\xa0', '').replace('\n',
                                                                                                    ''). \
