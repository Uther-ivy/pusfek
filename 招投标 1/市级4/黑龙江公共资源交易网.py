...
class wenshan_ggzy:
    def __init__(self):
        self.url_list = [
            'https://ggzyjyw.hlj.gov.cn/jyfwdt/003002/003002001/003002001001/{}.html', #招标公告
                    ]
        self.url1='https://ggzyjyw.hlj.gov.cn/jyfwdt/003002/003002001/003002001001/about2.html'
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail:
                ...
                url = 'https://ggzyjyw.hlj.gov.cn' + href
    ...
    def parse_detile(self, title, url, date):
        ...
        detail = url_html.xpath('//div[@class="ewb-art-bd"]')[0]
        detail_html = etree.tostring(detail, method='HTML')
        detail_html = html.unescape(detail_html.decode()).replace("display: none", '')
        detail_text = url_html.xpath('string(//div[@class="ewb-art-bd"])').replace('\xa0', '').replace('\n', ''). \
