...
class wenshan_ggzy:
    def __init__(self):
        self.url_list = [
            'http://www.cqzbcg.com/dlxx/003001/003001001/{}.html', #招标公告
                    ]
        self.url1='http://www.cqzbcg.com/dlxx/003001/003001001/dlxx.html'
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail:
                ...
                href = li.xpath('./p/a/@href')[0]
                url = 'http://www.cqzbcg.com' + href
