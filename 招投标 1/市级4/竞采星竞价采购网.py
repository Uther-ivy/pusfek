...
class wenshan_ggzy:
    def __init__(self):
        self.url_list = [
            'https://api.easyjcx.com/api/portalCli/tender/inteList', #招标公告
                    ]
        ...
        self.data={"condition":{"areaScope":"","classifyType":"","collegeIds":[],"noticeType":"","noticeTypes":["1","6","4","5","7","9","10","8"],"tenderType":""},"current":1,"size":100}
    def parse(self):
        date = tool.date
        # date = '2020-09-21'
        page = 0
        while True:
            ...
            for li in detail:
                ...
                url = 'https://api.easyjcx.com/api/portalCli/tender/inteDetail'
                # print(title, url, date_Today)
                # time.sleep(666)
                # self.parse_detile(title, url, date_Today,noticeId)
    ...
    def parse_detile(self, title, url,date,noticeId):
        print(url)
        data2 = {"noticeId": noticeId}
        ...
        index_url =f"https://www.easyjcx.com/#/integration/detail/{noticeId}"
