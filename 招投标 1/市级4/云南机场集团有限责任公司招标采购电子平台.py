...
# 云南机场集团有限责任公司招标采购电子平台
class wenshan_ggzy:
    def __init__(self):
        self.url_list = [
            'http://hc.ynairport.com/ynjccms//category/iframe.html?dates=300&categoryId=2&tabName=%E6%8B%9B%E6%A0%87%E5%85%AC%E5%91%8A&tenderMethod=01&page={}', #招标公告
                    ]
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail:
                ...
                date_Today = li.xpath('./a//div[@class="newsDate"]/div/text()')[0]
    ...
    def parse_detile(self, title, url, date):
        ...
        detail = url_html.xpath('//div[@class="Section0"]|//iframe[@id="pdfContainer"]/@src')[0]
        detail_html = etree.tostring(detail, method='HTML')
        detail_html = html.unescape(detail_html.decode()).replace("display: none", '')
        detail_text = url_html.xpath('string(//div[@class="Section0"]|//iframe[@id="pdfContainer"]/@src)').replace('\xa0', '').replace('\n', ''). \
        ...
        item['resource'] = '云南机场集团有限责任公司招标采购电子平台'
        item['shi'] = 6507
        item['sheng'] = 6500
        item['removal'] = title
        # print(item["body"])
