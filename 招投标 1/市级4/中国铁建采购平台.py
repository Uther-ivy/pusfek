...
class wenshan_ggzy:
    def __init__(self):
        self.url_list = [
            'https://www.crccep.com/crcc-purportal-manage/portal/specialtopic/findNoticesBynotices', #招标公告
                    ]
    ...
    def parse(self):
        ...
        while True:
            page += 1
            data = {"pageNum": page, "pageSize": 15, "noticeType": "1,2", "sourcingModeID": "ZBCG", "likeKey": "",
                    "purCompanyName": "", "orgLevel": "", "publishTimeBegin": "", "publishTimeEnd": ""}
            ...
            for li in detail:
                ...
                id = li["id"]
                url = f'https://www.crccep.com/crcc-purportal-manage/portal/specialtopic/findNoticesDetails?id={id}'
