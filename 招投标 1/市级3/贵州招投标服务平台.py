...
class baoshan_ggzy:
    def __init__(self):
        self.url_list = [
          'http://ztb.guizhou.gov.cn/api/trade/search?pubDate=all&pubType=all&region=5200&industry=all&prjType=all&noticeType=affiche&noticeClassify=all&pageIndex={}&args='
        ]
        self.url = self.url_list.pop(0)
        self.headers = {
            'Host': 'ztb.guizhou.gov.cn',
            'Referer': 'http://ztb.guizhou.gov.cn/trade/?category=affiche',
    ...
    def parse_detile(self, title, url, date):
        print(url)
        url1='http://ztb.guizhou.gov.cn/api/trade/'+url
        ...
        item = {}
        item['title'] = title
        item['url'] = 'http://ztb.guizhou.gov.cn/trade/bulletin/?id='+url
        item['date'] = date
