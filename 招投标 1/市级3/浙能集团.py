...
class alashan_ggzy:
    def __init__(self):
        ...
        self.domain_name='https://zsrm.zjenergy.com.cn'
    ...
    def parse(self):
        ...
        while True:
            page += 1
            url=f'https://zsrm.zjenergy.com.cn/zjnycms/category/iframe.html?searchDate=1997-12-13&dates=300&word=&categoryId=2&tenderMethod=01&status=&numPerPage=10&industryName=&page={page}'
            print('*' * 20, page, '*' * 20)
            ...
            for li in detail:
                title = li.xpath('./a//h5/text()')[0].replace('\xa0', '').replace('\n', ''). \
    ...
    def parse_detile(self, title, url, date):
        ...
        detail = url_html.xpath("//div[@class='textbox']/div")[0]
        # print(url_text)
