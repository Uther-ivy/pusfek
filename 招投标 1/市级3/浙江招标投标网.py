...
class wenshan_ggzy:
    def __init__(self):
        self.domain_name = 'http://www.zmctc.com'
        self.url_list = [
    ...
    def parse(self):
        ...
        while True:
            page += 1
            url=f'http://www.zmctc.com/zjgcjy/jyxx/004011/004011001/?Paging={page}'
            ...
            detail = html.xpath("//tr/td[2]/a")
            for li in range(1,len(detail)+1,2):
                title = html.xpath(f'//tr[{li}]/td[2]/a/@title')[0].replace('\n', '').replace('\r', '').replace('\t', '').replace(' ', '')
                url = html.xpath(f'//tr[{li}]/td[2]/a/@href')[0]
                date_Today = html.xpath(f"//tr[{li}]/td[3]/text()")[0].replace('\xa0', '').replace('\n', ''). \
    ...
    def parse_detile(self, title, url, date):
        ...
        detail = url_html.xpath("//td[@id='TDContent']")[0]
