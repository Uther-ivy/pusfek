...
class wenshan_ggzy:
    def __init__(self):
        self.domain_name = 'http://bidok.com.cn:8091'
        self.url_list = [
    ...
    def parse(self):
        ...
        while True:
            page += 1
            url=f'http://bidok.com.cn:8091/bidok-admin/web/ywNotices/cgNoticelist'
            payload = {
                'pageNum': page,
                'pageSize': 10,
                'noticeTitle':'',
            ...
            for li in detail:
                ...
                cid= li['noticeId']
                url = f'http://bidok.com.cn/view/announcementView.html?noticeId=847{cid}'
                city=li['provinceName']
    ...
    def parse_detile(self, title, url,date,city,cid):
        print(url)
        jsonurl='http://bidok.com.cn:8091/bidok-admin/web/ywNotices/findNoticeById'
        data={
            'id': cid
