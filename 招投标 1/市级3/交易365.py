...
class wenshan_ggzy:
    def __init__(self):
        self.domain_name = 'https://sx.jiaoyi365.com'
        self.url_list = [
    ...
    def parse(self):
        ...
        while True:
            page += 1
            url=f'https://sx.jiaoyi365.com/home-web-shanxi/cgxxRest/pageList'
            payload = {"xmLeiXing":"",
                       "ggXingZhi":"1",
                       "zbFangShi":"1,2",
                       "keyWords":'',
            ...
            for li in detail:
                ...
                guid1= li['guid1']
                guid2= li['guid2']
                shiXiangGuid= li['shiXiangGuid']
                url = f'https://sx.jiaoyi365.com/#/transaction-information/{guid2}?ggBdGuid={guid1}&ggXingZhi=1&shiXiangGuid={shiXiangGuid}&type=1'
                # city=li['area']
                date_Today =int(li['startTime']/1000)
                if 'http' not in url:
                ...
                if tool.Transformation(date) >= date_Today:
                    if tool.removal(title, date):
                        self.parse_detile(title, url, date_Today,guid1,guid2,shiXiangGuid)
                    else:
                        print('【existence】', url)
                        continue
                else:
    ...
    def parse_detile(self, title, url, date,guid1,guid2,shiXiangGuid):
        print(url)
        jsonurl='https://sx.jiaoyi365.com/home-web-shanxi/cgxxRest/detail'
        data={
            "guid1":guid1,
            "guid2":guid2,
            "ggXingZhi":"1",
        ...
        # print(t)
        data= json.loads(t)['data']['gg']
            # print(data)
        # time.sleep(2222)
        detail = etree.HTML(data['ggNeiRong'])
        ...
        item['mid'] = 867
        item['nativeplace'] = float(tool.get_title_city(detail_text))
