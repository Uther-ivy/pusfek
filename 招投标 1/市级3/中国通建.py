...
class alashan_ggzy:
    def __init__(self):
        ...
        self.domain_name='https://www.bdebid.com'
    ...
    def parse(self):
        ...
        while True:
            page += 1
            if page==1:
                url='https://www.bdebid.com/gggs/003001/detailpage.html'
            else:
                url = f'https://www.bdebid.com/gggs/003001/{page}.html'
            print('*' * 20, page, '*' * 20)
    ...
    def parse_detile(self, title, url, date):
        ...
        detail = url_html.xpath("//div[@class='ewb-trade-info']")[0]
        # print(url_text)
