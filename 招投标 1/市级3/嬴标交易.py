...
class wenshan_ggzy:
    def __init__(self):
        self.domain_name = 'https://www.fzbidding.com'
        self.url_list = [

        ]

        self.headers = {
            'Referer': 'https://www.fzbidding.com/portal/portalBidding/queryBiddingFirst',
    ...
    def parse(self):
        ...
        while True:
            page += 1
            url='https://www.fzbidding.com/portal/portalBidding/queryBiddingAgain'

            data = {"page":page,"limit":10,"portalBiddingType":"0","tenderProjectType":"A"}
            ...
            for li in detail:
                title = li['noticeName']
                id= li['id']
                url = f'https://www.fzbidding.com/portal/portalBidding/queryBiddingDetail?id={id}'
                date_Today = li['noticeSendTime']
                city=li['regionName']
                if 'http' not in url:
    ...
    def parse_detile(self, title, url, date,city):
        ...
        detail = url_html.xpath("//div[@class='in-content']")[0]
