...
class baoshan_ggzy:
    def __init__(self):
        self.url_list = [
          'http://www.hljggzyjyw.org.cn/jyfwdt/003002/003002001/about2.html',
          'http://www.hljggzyjyw.org.cn/jyfwdt/003002/003002001/{}.html',
        ]
...
function AES_Decrypt(word) {
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail:
                title = li.xpath('./div[@class="wb-data-infor"]/a/@title')[0].replace('\n', '').replace('\t', '').replace(' ', '').replace('\r', '')
                url1 = li.xpath('./div[@class="wb-data-infor"]/a/@href')[0]
                url = 'http://www.hljggzyjyw.org.cn/'+url1

                date_Today = li.xpath('./span[@class="wb-data-date"]/text()')[0]
                print(date_Today)
                if '测试' in title:
                    continue
    ...
    def parse_detile(self, title, url, date):
        ...
        detail = url_html.xpath('//div[@class="ewb-art"]')[0]
