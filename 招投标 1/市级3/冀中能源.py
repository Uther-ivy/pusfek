...
class wenshan_ggzy:
    def __init__(self):
        self.domain_name = 'https://www.jzbidding.com/cms/jzny/webfile'
        self.url_list = [
    ...
    def parse(self):
        ...
        while True:
            page += 1
            url=f'https://www.jzbidding.com/cms/api/dynamicData/queryContentPage'
            data={"pageNo":page,"pageSize":"10","dto":{"siteId":"747","categoryId":"5030","bidType":"","province":"","city":"","county":"","publishDays":""}}
            ...
            # time.sleep(6666)
            detail = json.loads(text)['res']['rows']
            for li in detail:
                title = li['title']
                city= li['cityName']
                url = li['url']
    ...
    def parse_detile(self, title, url, date,city):
        ...
        detail = url_html.xpath("//div[@class='text-part-text']")[0]
