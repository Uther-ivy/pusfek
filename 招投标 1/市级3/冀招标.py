...
class alashan_ggzy:
    def __init__(self):
        ...
        self.domain_name='https://www.jizhaobiao.com'
    ...
    def parse(self):
        ...
        while True:
            ...
            url = 'https://www.jizhaobiao.com/HB/TradeCenter/colTableInfo.do?t=0.7379848467850338'
            print('*' * 20, page, '*' * 20)
            data = {
                'projectName': ' ',
                'date': '1month',
            ...
            # print(11, text)
            # time.sleep(6666)
            detail = html.xpath("//dl/dt")
            for li in detail:
                title = li.xpath("./a[@class='txt-ell w980']/text()")[0].replace('\xa0', '').replace('\n', ''). \
                    replace('\r', '').replace('\t', '').replace(' ', '').replace('\xa5', '')
                url = li.xpath("./a[@class='txt-ell w980']/@href")[0]
    ...
    def parse_detile(self, title, url, date):
        ...
        detail = url_html.xpath("//div[@class='cui-Bidfold']")[0]
        # print(url_text)
