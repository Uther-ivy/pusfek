...
class wenshan_ggzy:
    def __init__(self):
        self.domain_name = 'https://nxzbtb.com.cn'
        self.url_list = [
    ...
    def parse(self):
        ...
        while True:
            page += 1
            url='https://gl.nxzbtb.com.cn/addons/public_serve/public/index.php/webapp/wepapp/Wepgetinfolist'
            payload = {
                'pageNo': page,
                'pageSize': 10,
                'goodname': '',
            ...
            for li in detail:
                ...
                if tool.Transformation(date) <= tool.Transformation(date_Today):
                    if tool.removal(title, date):
                        self.parse_detile(title, url, date_Today,cid,content)
                    else:
                        print('【existence】', url)
                        continue
                else:
    ...
    def parse_detile(self, title, url, date,cid,content):
        print(url)
