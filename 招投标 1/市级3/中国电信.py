...
class alashan_ggzy:
    def __init__(self):
        ...
        self.domain_name='https://zgdxjt.dlzb.com'

        self.headers = {
            'Referer': 'https://zgdxjt.dlzb.com/v1/1/',
            'Cookie': '__jsluid_s=5251f4a47f4f7a4161d1037d2a838ae6; D3z_vi-ds=d2d5ac6ea3d1f6d1596131bb3d854fde; Hm_lvt_c909c1510b4aebf2db610b8d191cbe91=1670400043; Hm_lpvt_c909c1510b4aebf2db610b8d191cbe91=1670400043',
    ...
    def parse(self):
        ...
        while True:
            page += 1
            url=f'https://zgdxjt.dlzb.com/v1/{page}/'
            print('*' * 20, page, '*' * 20)
            text = requests.session().get(url=url, headers=self.headers).content.decode().replace('&#x2f;', '/')
            html = HTML(text)
            # print(11, text)
            # time.sleep(6666)
