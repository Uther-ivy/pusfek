...
class baoshan_ggzy:
    def __init__(self):
        self.url_list = [
          'https://ggzy.xizang.gov.cn/jyxx_{}.jhtml',
        ]
...
function AES_Decrypt(word) {
    ...
    def parse(self):
        ...
        while True:
            ...
            # print(11, text)
            # time.sleep(6666)
            detail = html.xpath('//ul[@class="detail_content_right_box_content_ul"]/li')
            for li in detail:
                title = li.xpath('./p[1]/span[2]/text()')[0].replace('\n', '').replace('\t', '').replace(' ', '').replace('\r', '')
                url1 = li.xpath('./p[1]/@onclick')[0].replace("window.open('",'').replace("')",'')
                url = 'https://ggzy.xizang.gov.cn'+url1
    ...
    def parse_detile(self, title, url, date):
        ...
        detail = url_html.xpath('//div[@class="detailIndex_content"]|//div[@class="content-text"]')[0]
