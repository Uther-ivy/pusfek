...
class alashan_ggzy:
    def __init__(self):
        ...
        self.domain_name='https://www.cec-ec.com.cn'
    ...
    def parse(self):
        ...
        while True:
            page += 1
            url=f'https://www.cec-ec.com.cn/cms/channel/1xmgg0/index.htm?pageNo={page}'
            print('*' * 20, page, '*' * 20)
            ...
            for li in detail:
                title = li.xpath('./a/span[1]/text()')[0].replace('\xa0', '').replace('\n', ''). \
