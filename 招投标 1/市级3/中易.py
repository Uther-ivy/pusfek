...
class wenshan_ggzy:
    def __init__(self):
        self.domain_name = 'https://www.cotenders.cn'
        self.url_list = [
        ...
        self.headers = {
            ...
            'Origin': 'https://www.cotenders.cn',
            'Accept': 'application/json, text/javascript, */*; q=0.01',
            'Referer': 'https://www.cotenders.cn/PublicServer2.0/public/tradeInfoNew/tradeInfoNew.html',
    ...
    def parse(self):
        ...
        while True:
            page += 1
            url='https://www.cotenders.cn/PublicServer/commonAnnouncementAction/getCommonAnnouncementList.do'
            payload = {
                'page':page,
                'rows': 15,
                'businessType': '2',
            ...
            text = tool.requests_post_param(url,self.headers,param=payload)
            print('*' * 20, page, '*' * 20)
            ...
            for li in detail:
                ...
                # time.sleep(666)
                endtime=re.findall(r'\d{4}-\d{2}-\d{2}', li['sortTime'])[0]
    ...
    def parse_detile(self, title, url, date,cid,endtime):
        print(url)
        jsonurl='https://www.cotenders.cn/PublicServer/commonAnnouncementAction/selectPublishAnnouncementById.do'
        data={
            'id': cid,
        }
        ...
        # print(t)
        data= json.loads(t)['data']['announcement']
        # print(data)
        # time.sleep(2222)
