...
class alashan_ggzy:
    def __init__(self):
        ...
        self.domain_name='https://szecp.crc.com.cn'
    ...
    def parse(self):
        ...
        while True:
            page += 1
            if page==1:
                url='https://szecp.crc.com.cn/zbxx/006001/secondpagejy.html'
            else:
                url = f'https://szecp.crc.com.cn/zbxx/006001/{page}.html'
            print('*' * 20, page, '*' * 20)
            ...
            for li in detail:
                ...
                date_Today = li.xpath(".//td[@class='textcenter']/text()")[0].replace('\xa0', '').replace('\n', ''). \
