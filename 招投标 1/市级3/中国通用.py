...
class alashan_ggzy:
    def __init__(self):
        ...
        self.domain_name='https://www.china-tender.com.cn'
    ...
    def parse(self):
        ...
        while True:
            page += 1
            if page==1:
                url='https://www.china-tender.com.cn/gonggao/index.jhtml'
            else:
                url = f'https://www.china-tender.com.cn/gonggao/index_{page}.jhtml'
            print('*' * 20, page, '*' * 20)
            ...
            for li in detail:
                ...
                date_Today = li.xpath("./p/span[@class='Gray Right']/text()")[0].replace('\xa0', '').replace('\n', ''). \
