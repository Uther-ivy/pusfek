...
class baoshan_ggzy:
    def __init__(self):
        self.url_list = [
          'https://jxsggzy.cn/XZinterface/rest/esinteligentsearch/getFullTextDataNew'
        ]
...
function AES_Decrypt(word) {
    ...
    def parse(self):
        ...
        while True:
            page += 1
            page2=page*10
            data='{"token":"","pn":"'+str(page2)+'","rn":10,"sdt":"","edt":"","wd":"","inc_wd":"","exc_wd":"","fields":"","cnum":"","sort":"{\\"webdate\\":\\"0\\",\\"id\\":\\"0\\"}","ssort":"","cl":10000,"terminal":"","condition":[{"fieldName":"categorynum","equal":"002","notEqual":null,"equalList":null,"notEqualList":null,"isLike":true,"likeType":2}],"time":[{"fieldName":"webdate","startTime":"2022-10-06 00:00:00","endTime":"2023-01-04 23:59:59"}],"highlights":"","statistics":null,"unionCondition":[],"accuracy":"","noParticiple":"1","searchRange":null,"noWd":true}'
            print(data)
            text = tool.requests_post(self.url.format(page), headers=self.headers,data=data)
            print('*' * 20, page, '*' * 20)
            print(text)
            ...
            for li in detail:
                title = li['title']
                url1 = li['linkurl']
                url = 'https://jxsggzy.cn'+url1

                date_Today = li['infodate'].split(' ')[0]
                if '测试' in title:
                    continue
