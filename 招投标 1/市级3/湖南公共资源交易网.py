...
class baoshan_ggzy:
    def __init__(self):
        self.url_list = [
          'https://www.hnsggzy.com/jygk/index_{}.jhtml',
        ]
...
function AES_Decrypt(word) {
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail:
                title = ''
                url1 = li.xpath('./a/@href')[0]
                url = url1

                date_Today = li.xpath('//div[@class="list-times"]/text()')[0]
                print(date_Today)
                if '测试' in title:
                    continue
    ...
    def parse_detile(self, title, url, date):
        ...
        if len(detail_text) < 300:
            return
        item = {}
        item['title'] = url_html.xpath('//div[@class="content-title"]/text()')[0]
        item['url'] = url
        item['date'] = date
