...
class wenshan_ggzy:
    def __init__(self):
        self.domain_name = 'http://ec.crrcgc.cc'
        self.url_list = [
    ...
    def parse(self):
        ...
        while True:
            page += 1
            url=f'http://ec.crrcgc.cc/enquire/queryEnquireBillList.do?pageNo={page}&pageSize=15&keyName=&_={time.time()*1000}'
            ...
            for li in detail:
                title = li['enqutopic']
                id= li['id']
                url = f'http://ec.crrcgc.cc/ReadyAction!getAttachedFilesOutLine.do?invoiceno={id}&invoicetype='
                date_Today = li['sendtime']
