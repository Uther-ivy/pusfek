...
class alashan_ggzy:
    def __init__(self):
        ...
        self.domain_name='https://zcpt.cebenvironment.com.cn'
    ...
    def parse(self):
        ...
        while True:
            ...
            url=f'https://zcpt.cebenvironment.com.cn/cms/category/iframe.html?.html?searchDate=1997-12-12&dates=300&categoryId=2&tabName=%E6%8B%9B%E6%A0%87%E5%85%AC%E5%91%8A&precise=&status=&tenderno=&goSearch=&tenderMethod=&page={page}'
            print('*' * 20, page, '*' * 20)
            ...
            for li in detail:
                ...
                date_Today = li.xpath(".//li[3]/span/text()")[0].replace('\xa0', '').replace('\n', ''). \
