...
class alashan_ggzy:
    def __init__(self):
        ...
        self.domain_name='https://dzzb.jnkgjtdzzbgs.com'
    ...
    def parse(self):
        ...
        while True:
            page += 1
            url=f'https://dzzb.jnkgjtdzzbgs.com/cms/channel/1ywgg1qb/index.htm?pageNo={page}'
            print('*' * 20, page, '*' * 20)
            ...
            for li in detail:
                ...
                date_Today = li.xpath("./a/em/text()")[0].replace('\xa0', '').replace('\n', ''). \
