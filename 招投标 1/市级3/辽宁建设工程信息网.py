...
class alashan_ggzy:
    def __init__(self):
        ...
        self.domain_name='http://218.60.147.115'
    ...
    def parse(self):
        ...
        while True:
            page += 1
            if page==1:
                url='http://218.60.147.115/gcjy/003001/about.html'
            else:
                url = f'http://218.60.147.115/gcjy/003001/{page}.html'
            print('*' * 20, page, '*' * 20)
            ...
            for li in detail:
                ...
                date_Today = li.xpath("./span[@class='wb-data-date']/text()")[0].replace('\xa0', '').replace('\n', ''). \
    ...
    def parse_detile(self, title, url, date):
        ...
        detail = url_html.xpath("//div[@class='news-article-para']")[0]
        # print(url_text)
