...
class alashan_ggzy:
    def __init__(self):
        ...
        self.domain_name='http://www.sxyjcg.com'
    ...
    def parse(self):
        ...
        while True:
            page += 1
            for typeid in ['hzbgg','gzbgg','fzbgg']:
                if page== 1:
                    url=f'http://www.sxyjcg.com/{typeid}/index_.jhtml'
                else:
                    url=f'http://www.sxyjcg.com/{typeid}/index_{page}.jhtml'
                print('*' * 20, page, '*' * 20)
                ...
                detail = html.xpath("//ul/li[@class='PaddingLR15 BorderBottomEEE']")
                for li in detail:
    ...
    def parse_detile(self, title, url, date):
        ...
        detail = url_html.xpath("//div[@class='Padding10 BorderCCCDot F14']")[0]
        # print(url_text)
