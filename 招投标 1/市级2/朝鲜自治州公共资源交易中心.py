...
class wenshan_ggzy:
    def __init__(self):
        self.domain_name = 'http://ybggzy.com'
        self.url_list = [
    ...
    def parse(self):
        ...
        while True:
            page += 1
            if page == 1:
                if '005001' in self.url:
                    text = tool.requests_get(self.url.format('aboutsub'), self.headers)
                else:
                    text = tool.requests_get(self.url.format('aboutsubgc'), self.headers)
            else:
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['4009.001', '延吉'], ['4009.002', '图们'], ['4009.003', '敦化'], ['4009.004', '珲春'], ['4009.005', '龙井'], ['4009.006', '和龙'], ['4009.007', '汪清县'], ['4009.008', '安图县']]
