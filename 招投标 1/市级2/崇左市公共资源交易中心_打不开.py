...
class wenshan_ggzy:
    def __init__(self):
        self.domain_name = 'http://www.czjyzx.gov.cn'
        self.url_list = [
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['10514.001', '江洲区'], ['10514.002', '扶绥县'], ['10514.003', '宁明县'], ['10514.004', '龙州县'], ['10514.005', '大新县'], ['10514.006', '天等县'], ['10514.007', '凭祥']]
