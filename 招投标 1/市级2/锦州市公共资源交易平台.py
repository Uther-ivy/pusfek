...
class jinzhou_ggzy:
    ...
    def parse(self):
        ...
        while True:
            ...
            if page == 1:
                text = tool.requests_get(self.url.format('moreinfojy'), self.headers)
            print('*' * 20, page, '*' * 20)
            html = HTML(text)
            # print(11, text)
            # time.sleep(6666)
            ...
            for li in detail:
                ...
                url = 'http://ggzy.jz.gov.cn' + li.xpath('./div/a/@href')[0]
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['3507.001', '古塔区'], ['3507.002', '凌河区'], ['3507.003', '太和区'], ['3507.004', '黑山县'], ['3507.005', '义县'], ['3507.006', '凌海市'], ['3507.007', '北宁市']]
        for i in city_list:
            if i[1] in addr:
                city = float(i[0])
                break
