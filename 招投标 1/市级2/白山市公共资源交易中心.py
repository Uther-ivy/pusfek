...
class baishan_ggzy:
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail:
                ...
                url = 'http://bsggzyjy.cbs.gov.cn' + li.xpath('./div/a/@href')[0]
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['4006.001', '八道江区'], ['4006.002', '抚松县'], ['4006.003', '靖宇县'], ['4006.004', '长白朝鲜族自治县'], ['4006.005', '江源县'], ['4006.006', '临江市']]
        for i in city_list:
            if i[1] in addr:
                city = float(i[0])
                break
