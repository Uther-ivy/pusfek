...
class diqing_ggzy:
        ...
        while True:
            ...
            for i in range(1, len(detail)):
                try:
                    ...
                    url = 'http://183.224.249.60:8001' + html.xpath(self.url[1] + '[{}]/td[3]/a/@href'.format(i + 1))[0]
                    ...
                    url = 'http://183.224.249.60:8001' + html.xpath(self.url[1] + '[{}]/td[4]/a/@href'.format(i + 1))[0]
                    date_Today = html.xpath(self.url[1] + '[{}]/td[5]/text()'.format(i + 1))[0]
                    if title == '':
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['13016.001', '香格里拉县'], ['13016.002', '德钦县'], ['13016.003', '维西傈僳族自治县']]
        for i in city_list:
            if i[1] in addr:
                city = float(i[0])
                break
