...
class baoshan_ggzy:
    def __init__(self):
        ...
        self.data_list=[
            {"keyword": "", "regionCode": "", "regionLevel": "", "noticeType": "c_tender_notice_p", "tradeCode": "",
             "classificationCode": "", "time": "", "size": 10, "number": 1, "total": 7839},
            {"keyword": "", "regionCode": "", "regionLevel": "", "noticeType": "c_tender_notice", "tradeCode": "",
             "classificationCode": "", "time": "", "size": 10, "number": 1, "total": 120},
            {"keyword": "", "regionCode": "", "regionLevel": "", "noticeType": "c_tender_doc", "tradeCode": "",
             "classificationCode": "", "time": "", "size": 10, "number": 1, "total": 7839},
            {"keyword": "", "regionCode": "", "regionLevel": "", "noticeType": "c_win_candidate_publicity",
             "tradeCode": "", "classificationCode": "", "time": "", "size": 10, "number": 1, "total": 226},
            {"keyword": "", "regionCode": "", "regionLevel": "", "noticeType": "c_wid_bidder_publicity",
             "tradeCode": "", "classificationCode": "", "time": "", "size": 10, "number": 1, "total": 8346},
            {"keyword": "", "regionCode": "", "regionLevel": "", "noticeType": "c_written_exception_record",
             "tradeCode": "", "classificationCode": "", "time": "", "size": 10, "number": 1, "total": 8041},
            {"keyword": "", "regionCode": "", "regionLevel": "", "noticeType": "c_bid_exception_report",
             "tradeCode": "", "classificationCode": "", "time": "", "size": 10, "number": 1, "total": 0}
                   ]
    ...
    def parse(self):
        while True:
            date = tool.date
            # date='2021-03-31'
            text = tool.requests_post_to(url=self.url, headers=self.headers,data=self.data)
            # print(text)
            detail = json.loads(text)['data']['list']
            for li in detail:
                # try:
                url = f'http://www.lntb.gov.cn/#/cBidExceptionReport?id={li["id"]}'
                # except:
                    # url = f'http://epp.ctg.com.cn/static/temphtml/{li["ARTICLE_CHANGE_ID"]}.html'
                title = li["title"]
                date_Today = str(li["time"]).split('T')[0]
                if '测试' in title:
                    continue
                ...
                if tool.Transformation(date) <= tool.Transformation(date_Today):
                    ...
                    print('日期不符, 正在切换类型', date_Today, self.data)
                    self.data = self.data_list.pop(0)
                    page = 0
                    break
            self.data = self.data_list.pop(0)
    ...
    def parse_detile(self, title, url, date):
        t = tool.selenium_get(url, self.headers)
