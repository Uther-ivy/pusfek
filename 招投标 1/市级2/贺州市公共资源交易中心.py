...
class wenshan_ggzy:
    def __init__(self):
        self.domain_name = 'http://ggzyjy.gxhz.gov.cn'
        self.url_list = [
            'http://ggzyjy.gxhz.gov.cn/zbgg/index{}.shtml',
            'http://ggzyjy.gxhz.gov.cn/zbgs/index{}.shtml',
            'http://ggzyjy.gxhz.gov.cn/bcgg/index{}.shtml',
        ]
    ...
    def parse(self):
        ...
        while True:
            ...
            # time.sleep(6666)
            detail = html.xpath('//*[@id="morelist"]//li')
            for li in detail:
    ...
    def parse_detile(self, title, url, date):
        ...
        detail_text = url_html.xpath('string(//*[@class="view TRS_UEDITOR trs_paper_default trs_word"])').replace('\xa0', '').replace('\n',
                                                                                                             ''). \
            replace('\r', '').replace('\t', '').replace(' ', '').replace('\xa5', '')
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['10511.001', '八步区'], ['10511.002', '昭平县'], ['10511.003', '钟山县'], ['10511.004', '富川瑶族自治县']]
