...
class wenshan_ggzy:
    def __init__(self):
        self.domain_name = 'http://www.baoan.gov.cn'
        self.url_list = [
            'http://www.baoan.gov.cn/gkmlpt/api/all/20556?page=1&sid=755037'
        ]
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail:
                ...
                url = li['url']
                date_Today = li['created_at'][:10].replace('\xa0', '').replace('\n', ''). \
