...
class honghe_ggzy:
        ...
        while True:
            ...
            for i in range(1, len(detail)):
                try:
                    ...
                    url = 'https://www.hhzy.net' + html.xpath(self.url[1] + '[{}]/td[3]/a/@href'.format(i + 1))[0]
                    ...
                    url = 'https://www.hhzy.net' + html.xpath(self.url[1] + '[{}]/td[4]/a/@href'.format(i + 1))[0]
                    date_Today = html.xpath(self.url[1] + '[{}]/td[5]/text()'.format(i + 1))[0]
                    if title == '':
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['13010.001', '个旧'], ['13010.01', '金平苗族瑶族傣族自治县'], ['13010.011', '绿春县'], ['13010.012', '河口瑶族自治县'], ['13010.002', '开远'], ['13010.003', '蒙自县'], ['13010.004', '屏边苗族自治县'], ['13010.005', '建水县'], ['13010.006', '石屏县'], ['13010.007', '弥勒县'], ['13010.008', '泸西县'], ['13010.009', '元阳县']]
