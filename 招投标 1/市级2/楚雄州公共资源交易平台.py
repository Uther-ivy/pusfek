...
class chuxiong_ggzy:
        ...
        while True:
            ...
            for i in range(1, len(detail)):
                try:
                    ...
                    url = 'http://www.cxggzy.cn' + html.xpath(self.url[1] + '[{}]/td[3]/a/@href'.format(i + 1))[0]
                    ...
                    url = 'http://www.cxggzy.cn' + html.xpath(self.url[1] + '[{}]/td[4]/a/@href'.format(i + 1))[0]
                    date_Today = html.xpath(self.url[1] + '[{}]/td[5]/text()'.format(i + 1))[0]
                    if title == '':
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['13009.001', '楚雄市'], ['13009.01', '禄丰县'], ['13009.002', '双柏县'], ['13009.003', '牟定县'], ['13009.004', '南华县'], ['13009.005', '姚安县'], ['13009.006', '大姚县'], ['13009.007', '永仁县'], ['13009.008', '元谋县'], ['13009.009', '武定县']]
        for i in city_list:
            if i[1] in addr:
                city = float(i[0])
                break
