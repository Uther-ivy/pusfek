...
class baoshan_ggzy:
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail:
                ...
                if 'http' not in url:
                    url = 'http://www.lnsggzyjy.cn' + url
                if 'http://www.lnsggzyjy.cn' not in url:
                    continue
    ...
    def parse_detile(self, title, url, date):
        ...
        try:
            detail = url_html.xpath('//*[@class="hidden"]')[0]
            detail_html = etree.tostring(detail, method='HTML')
            detail_html = html.unescape(detail_html.decode())
            detail_text = url_html.xpath('string(//*[@class="hidden"])').replace('\xa0', '').replace('\n',
                                                                                                      ''). \
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['14512.001', '武都区'], ['14512.002', '成县'], ['14512.003', '文县'], ['14512.004', '宕昌县'], ['14512.005', '康县'], ['14512.006', '西和县'], ['14512.007', '礼县'], ['14512.008', '徽县'], ['14512.009', '两当县']]
