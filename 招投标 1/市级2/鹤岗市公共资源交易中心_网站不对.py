...
class wenshan_ggzy:
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail:
                ...
                url = 'http://www.hgggzyjyw.org.cn' + li.xpath('./a/@href')[0]
    ...
    def parse_detile(self, title, url, date):
        ...
        detail_text = url_html.xpath('string(/html/body/div[2]/div/div[2]/div/div/div[2]/div[1])').replace('\xa0', '').replace('\n', '').\
            replace('\r', '').replace('\t', '').replace(' ', '').replace('\xa5', '')
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['4504.001', '向阳区'], ['4504.002', '工农区'], ['4504.003', '南山区'], ['4504.004', '兴安区'], ['4504.005', '东山区'], ['4504.006', '兴山区'], ['4504.007', '萝北县'], ['4504.008', '绥滨县']]
