...
class baoshan_ggzy:
    def __init__(self):
        self.url_list = [
            'http://www.hubeibidding.com/list/26.html',
            'http://www.hubeibidding.com/list/27.html',
            'http://www.hubeibidding.com/list/28.html',
            'http://www.hubeibidding.com/list/31.html',
            'http://www.hubeibidding.com/list/32.html',
            'http://www.hubeibidding.com/list/33.html',
            'http://www.hubeibidding.com/list/34.html',
            'http://www.hubeibidding.com/list/35.html',
            'http://www.hubeibidding.com/list/36.html',
            'http://www.hubeibidding.com/list/37.html',
            'http://www.hubeibidding.com/list/14.html',
    ...
    def parse(self):
        while True:
            ...
            # time.sleep(2222)
            html = HTML(text)
            detail = html.xpath('//*[@class="dynamic_content_center"]/a')
            for li in detail:
                url='http://www.hubeibidding.com'+li.xpath('./@href')[0]
                title = li.xpath('./h3/text()')[0]
                date_Today  = date[:5]+li.xpath('./span[1]/p[1]/text()')[0].replace('月', '-')+li.xpath('./span[1]/p[2]/text()')[0]
    ...
    def parse_detile(self, title, url, date):
        ...
        detail = url_html.xpath('//div[@class="w1200"]')[0]
        # print(detail)
        detail_html = etree.tostring(detail, method='HTML')
        detail_html = html.unescape(detail_html.decode())
        detail_text = url_html.xpath('string(//div[@class="w1200"])').replace('\xa0', '').replace('\n', ''). \
