...
class dali_ggzy:
        ...
        while True:
            ...
            for i in range(1, len(detail)):
                try:
                    ...
                    url = 'https://www.dlggzy.cn' + html.xpath(self.url[1] + '[{}]/td[3]/a/@href'.format(i + 1))[0]
                    ...
                    url = 'https://www.dlggzy.cn' + html.xpath(self.url[1] + '[{}]/td[4]/a/@href'.format(i + 1))[0]
                    date_Today = html.xpath(self.url[1] + '[{}]/td[5]/text()'.format(i + 1))[0]
                    if title == '':
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['13013.001', '大理市'], ['13013.01', '洱源县'], ['13013.011', '剑川县'], ['13013.012', '鹤庆县'], ['13013.002', '漾濞彝族自治县'], ['13013.003', '祥云县'], ['13013.004', '宾川县'], ['13013.005', '弥渡县'], ['13013.006', '南涧彝族自治县'], ['13013.007', '巍山彝族回族自治县'], ['13013.008', '永平县'], ['13013.009', '云龙县']]
        for i in city_list:
            if i[1] in addr:
                city = float(i[0])
                break
