...
class wenshan_ggzy:
    def __init__(self):
        self.url_list = ['http://ggzyjy.benxi.gov.cn/jyxx/003001/003001001/{}.html',        #工程建设
    ...
    def parse(self):
        ...
        while True:
            page += 1
            if page == 1:
                text = tool.requests_get(self.url.format('listjyxx'), self.headers)
            else:
            ...
            for li in detail:
                ...
                url = 'http://ggzyjy.benxi.gov.cn' + li.xpath('./a/@href')[0]
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['3505.001', '平山区'], ['3505.002', '溪湖区'], ['3505.003', '明山区'], ['3505.004', '南芬区'], ['3505.005', '本溪满族自治县'], ['3505.006', '桓仁满族自治县']]
