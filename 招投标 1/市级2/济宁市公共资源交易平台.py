...
class baoshan_ggzy:
    ...
    def parse(self):
        ...
        while True:
            data = {"skipCount":page*20,"maxResultCount":20,"categoryCode":self.url,"includeAllSite":True,"FilterText":"","tenantId":"3","regionId":"0","tenderProjectType":""}
            page += 1
            ...
            for li in detail:
                ...
                url = li['id']
                if 'http' not in url:
                    url = 'http://jnggzy.jnzbtb.cn/JiNing/Bulletins/Detail/{}/?CategoryCode={}'.format(url, self.url)
    ...
    def parse_detile(self, title, url, date):
        ...
        detail = url_html.xpath('//*[@class="bulletin-content"]')[0]
        detail_html = etree.tostring(detail, method='HTML')
        detail_html = html.unescape(detail_html.decode())
        detail_text = url_html.xpath('string(//*[@class="bulletin-content"])').replace('\xa0', '').replace('\n',
                                                                                                     ''). \
