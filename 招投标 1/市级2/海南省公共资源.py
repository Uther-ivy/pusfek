...
def get_zhaobiao_info(zhao_time, info_url, title):
    ...
    if resp.status_code == 200:
        ...
        item['body'] = sel.xpath('//div[@class="newsCon"]').extract_first()
        detail = sel.xpath('string(//div[@class="newsCon"])').extract_first()
...
def get_project(url):
    ...
    resp.encoding = 'uft8'
    sel = Selector(resp)
    titles = sel.xpath('//table[@class="newtable"]/tbody/tr[position()<11]')
    now_time = tool.date
    for ti in titles:
        title = ti.xpath('./td[last()-1]/a/@title').extract_first().strip()
        info_url = ti.xpath('./td[last()-1]/a/@href').extract_first()
...
if __name__ == '__main__':
    ...
    url_list = [
            "http://zw.hainan.gov.cn/ggzy/ggzy/jgzbgg/index_1.jhtml",
            "http://zw.hainan.gov.cn/ggzy/ggzy/jgzbgg/index_2.jhtml",
            "http://zw.hainan.gov.cn/ggzy/ggzy/jgzbgs/index_1.jhtml",
            "http://zw.hainan.gov.cn/ggzy/ggzy/jgzbgs/index_2.jhtml",
            "http://zw.hainan.gov.cn/ggzy/ggzy/jsqtgg/index_1.jhtml",
            "http://zw.hainan.gov.cn/ggzy/ggzy/jsqtgg/index_2.jhtml",
            "http://zw.hainan.gov.cn/ggzy/ggzy/cggg/index_1.jhtml",
            "http://zw.hainan.gov.cn/ggzy/ggzy/cggg/index_2.jhtml",
            "http://zw.hainan.gov.cn/ggzy/ggzy/cgzbgg/index_1.jhtml",
            "http://zw.hainan.gov.cn/ggzy/ggzy/cgzbgg/index_2.jhtml",
            "http://zw.hainan.gov.cn/ggzy/ggzy/zfcgqtgg/index_1.jhtml",
            "http://zw.hainan.gov.cn/ggzy/ggzy/zfcgqtgg/index_2.jhtml"
    ]
    for url in url_list:
        print(url)
        get_project(url)