...
class dehong_ggzy:
        ...
        while True:
            ...
            for i in range(1, len(detail)):
                try:
                    ...
                    url = 'https://jyzx.dh.gov.cn' + html.xpath(self.url[1] + '[{}]/td[3]/a/@href'.format(i + 1))[0]
                    ...
                    url = 'https://jyzx.dh.gov.cn' + html.xpath(self.url[1] + '[{}]/td[4]/a/@href'.format(i + 1))[0]
                    date_Today = html.xpath(self.url[1] + '[{}]/td[5]/text()'.format(i + 1))[0]
                    if title == '':
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['13014.001', '瑞丽市'], ['13014.002', '潞西市'], ['13014.003', '梁河县'], ['13014.004', '盈江县'], ['13014.005', '陇川县']]
        for i in city_list:
            if i[1] in addr:
                city = float(i[0])
                break
