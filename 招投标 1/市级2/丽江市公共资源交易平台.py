...
class lijiang_ggzy:
        ...
        while True:
            ...
            for i in range(1, len(detail)):
                try:
                    ...
                    url = 'https://www.ljggzyxx.cn' + html.xpath(self.url[1] + '[{}]/td[3]/a/@href'.format(i + 1))[0]
                    try:
                    ...
                    url = 'https://www.ljggzyxx.cn' + html.xpath(self.url[1] + '[{}]/td[4]/a/@href'.format(i + 1))[0]
                    date_Today = html.xpath(self.url[1] + '[{}]/td[5]/text()'.format(i + 1))[0]
                    if title == '':
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['13006.001', '古城区'], ['13006.002', '玉龙纳西族自治县'], ['13006.003', '永胜县'], ['13006.004', '华坪县'], ['13006.005', '宁蒗彝族自治县']]
        for i in city_list:
            if i[1] in addr:
                city = float(i[0])
                break
