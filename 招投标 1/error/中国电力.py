...
class alashan_ggzy:
    def __init__(self):
        ...
        self.domain_name='https://ldky.dlzb.com'
    ...
    def parse(self):
        ...
        # date = '2020-01-06'
        page = 0
        urllist=[f'https://ldky.dlzb.com/v1/{page}/',
                 f'https://ldky.dlzb.com/v2/{page}/',
                 f'https://ldky.dlzb.com/v3/{page}/',
                 f'https://ldky.dlzb.com/v4/{page}/',
                 f'https://ldky.dlzb.com/v5/{page}/',]
        while True:
            page += 1
            for url in urllist:
                print('*' * 20, page, '*' * 20)
