...
class wenshan_ggzy:
    ...
    def parse(self):
        ...
        page = 0
        while True:
            data = {"token":"","pn":page*15,"rn":15,"sdt":"","edt":"","wd":"","inc_wd":"","exc_wd":"","fields":"title","cnum":"010","sort":"{\"infodatepx\":\"0\"}","ssort":"title","cl":200,"terminal":"","condition":[{"fieldName":"categorynum","equal":"001001001001","notEqual":None,"equalList":None,"notEqualList":None,"isLike":True,"likeType":2}],"time":None,"highlights":"","statistics":None,"unionCondition":None,"accuracy":"","noParticiple":"0","searchRange":None,"isBusiness":"1"}
            page += 1
            ...
            for li in detail:
                title = li['title']
                url = 'http://ggzy.jgswj.gxzf.gov.cn/ylggzy' + li['linkurl']
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['10509.001', '玉州区'], ['10509.002', '容县'], ['10509.003', '陆川县'], ['10509.004', '博白县'], ['10509.005', '兴业县'], ['10509.006', '北流']]
