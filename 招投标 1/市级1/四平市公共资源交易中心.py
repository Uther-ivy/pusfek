...
class siping_ggzy:
    def __init__(self):
        ...
        self.headers = {
            'Cookie': '_gscu_658937685=79137573iv658885; _gscbrs_658937685=1; _gscs_658937685=79137573j2ngx885|pv:8',
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail:
                ...
                url = 'http://ggzy.siping.gov.cn' + li.xpath('./div/a/@href')[0]
    ...
    def parse_detile(self, title, url, date):
        ...
        detail = url_html.xpath('/html/body/div[2]/div/div[2]')[0]
        detail_html = etree.tostring(detail, method='HTML')
        detail_html = html.unescape(detail_html.decode())
        detail_text = url_html.xpath('string(/html/body/div[2]/div/div[2])').replace('\xa0', '').replace('\n', ''). \
