...
class qujing_ggzy:
    def __init__(self):
        self.url_list = [
            ...
            #   工程建设
            #       招标公告
            ['http://220.164.171.157/jyxx/jsgcZbgg?currentPage={}','//*[@id="zbggForm"]/div[3]/table/tr'],
            #       变更公告
            # ['http://220.164.171.157/jyxx/jsgcBgtz?currentPage={}','//*[@id="bgtzForm"]/div[2]/table/tr'],
            #       评标结果公示
            ['http://220.164.171.157/jyxx/jsgcpbjggs?currentPage={}','//*[@id="zbggForm"]/div[2]/table/tr'],
            #       中标结果
            ['http://220.164.171.157/jyxx/jsgcZbjggs?currentPage={}','//*[@id="zbggForm"]/div[3]/table/tr'],
            #       异常公告
            ['http://220.164.171.157/jyxx/jsgcZbyc?currentPage={}','//*[@id="ycggForm"]/div[2]/table/tr'],
            #   政府采购
            #       采购公告
            ['http://220.164.171.157/jyxx/zfcg/cggg?currentPage={}','//*[@id="zbggForm"]/div[2]/table/tr'],
            #       变更通知
            ['http://220.164.171.157/jyxx/zfcg/gzsx?currentPage={}','//*[@id="zbggForm"]/div[2]/table/tr'],
            #       结果公示
            ['http://220.164.171.157/jyxx/zfcg/zbjggs?currentPage={}','//*[@id="zbggForm"]/div[2]/table/tr'],
            #       异常公示
            ['http://220.164.171.157/jyxx/zfcg/zfcgYcgg?currentPage={}','//*[@id="ycggForm"]/div[2]/table/tr']
        ]
        ...
        while True:
            ...
            for i in range(1, len(detail)):
                try:
                    ...
                    url = 'http://220.164.171.157' + html.xpath(self.url[1] + '[{}]/td[3]/a/@href'.format(i + 1))[0]
                    ...
                    url = 'http://220.164.171.157' + html.xpath(self.url[1] + '[{}]/td[4]/a/@href'.format(i + 1))[0]
                    date_Today = html.xpath(self.url[1] + '[{}]/td[5]/text()'.format(i + 1))[0]
                    if title == '':
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['13002.001', '麒麟区'], ['13002.002', '马龙县'], ['13002.003', '陆良县'], ['13002.004', '师宗县'], ['13002.005', '罗平县'], ['13002.006', '富源县'], ['13002.007', '会泽县'], ['13002.008', '沾益县'], ['13002.009', '宣威市']]
        for i in city_list:
            if i[1] in addr:
                city = float(i[0])
                break
