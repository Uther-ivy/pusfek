...
class nujiang_ggzy:
        ...
        while True:
            ...
            for i in range(1, len(detail)):
                try:
                    ...
                    url = 'http://182.246.203.127:8001' + html.xpath(self.url[1] + '[{}]/td[3]/a/@href'.format(i + 1))[0]
                    ...
                    url = 'http://182.246.203.127:8001' + html.xpath(self.url[1] + '[{}]/td[4]/a/@href'.format(i + 1))[0]
                    date_Today = html.xpath(self.url[1] + '[{}]/td[5]/text()'.format(i + 1))[0]
                    if title == '':
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['13015.001', '泸水县'], ['13015.002', '福贡县'], ['13015.003', '贡山独龙族怒族自治县'], ['13015.004', '兰坪白族普米族自治县']]
        for i in city_list:
            if i[1] in addr:
                city = float(i[0])
                break
