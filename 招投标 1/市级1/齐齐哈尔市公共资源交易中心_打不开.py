...
class wenshan_ggzy:
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail:
                ...
                url = 'http://ggzy.qqhr.gov.cn' + li.xpath('./div/a/@href')[0]
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['4502.001', '龙沙区'], ['4502.01', '甘南县'], ['4502.011', '富裕县'], ['4502.012', '克山县'], ['4502.013', '克东县'], ['4502.014', '拜泉县'], ['4502.015', '讷河'], ['4502.002', '建华区'], ['4502.003', '铁锋区'], ['4502.004', '昂昂溪区'], ['4502.005', '富拉尔基区'], ['4502.006', '碾子山区'], ['4502.007', '梅里斯达斡尔族区'], ['4502.008', '龙江县 依安县'], ['4502.009', '泰来县']]
