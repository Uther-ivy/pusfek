...
def get_zhaobiao_info(zhao_time, info_url, title):
    ...
    if resp.status_code == 200:
        ...
        item['body'] = sel.xpath('//*[@id="Zoom"]').extract_first()
        detail = sel.xpath('string(//*[@id="Zoom"])').extract_first()
...
if __name__ == '__main__':
    ...
    try:
        ...
        url_list = [
            "http://jyzx.xiangyang.gov.cn/jyxx/gcjs/zbgg/",
            "http://jyzx.xiangyang.gov.cn/jyxx/gcjs/dycq/",
            "http://jyzx.xiangyang.gov.cn/jyxx/gcjs/pbjggs/",
            "http://jyzx.xiangyang.gov.cn/jyxx/gcjs/zbjggg/",
            "http://jyzx.xiangyang.gov.cn/jyxx/gcjs/zbycgg/",
        ]
        for url in url_list:
            get_project(url)
