...
class wenshan_ggzy:
        ...
        while True:
            ...
            for i in range(1, len(detail)):
                try:
                    ...
                    url = 'https://wsggzy.cn' + html.xpath(self.url[1] + '[{}]/td[3]/a/@href'.format(i + 1))[0]
                    ...
                    url = 'https://wsggzy.cn' + html.xpath(self.url[1] + '[{}]/td[4]/a/@href'.format(i + 1))[0]
                    date_Today = html.xpath(self.url[1] + '[{}]/td[5]/text()'.format(i + 1))[0]
                    if title == '':
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['13011.001', '文山县'], ['13011.002', '砚山县'], ['13011.003', '西畴县'], ['13011.004', '麻栗坡县'], ['13011.005', '马关县'], ['13011.006', '丘北县'], ['13011.007', '广南县'], ['13011.008', '富宁县']]
