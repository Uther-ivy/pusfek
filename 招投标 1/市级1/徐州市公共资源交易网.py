...
class baoshan_ggzy:
    def __init__(self):
        self.url_list = [
            'http://ggzy.zwb.xz.gov.cn/services/XzsJsggWebservice/getList?response=application/json&pageIndex={}&pageSize=15&&categorynum=&bianhao=&xmmc=&diqutype=',
                         ]
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail:
                ...
                url = li['href']
                if 'http' not in url:
                    url = 'http://ggzy.zwb.xz.gov.cn' + url
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['5503.001', '鼓楼区'], ['5503.01', '新沂市'], ['5503.011', '邳州市'], ['5503.002', '云龙区'], ['5503.003', '九里区'], ['5503.004', '贾汪区'], ['5503.005', '泉山区'], ['5503.006', '丰县'], ['5503.007', '沛县'], ['5503.008', '铜山县'], ['5503.009', '睢宁县']]
