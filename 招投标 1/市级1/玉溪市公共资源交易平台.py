...
class yuxi_ggzy:
        ...
        while True:
            ...
            for i in range(1, len(detail)):
                try:
                    ...
                    url = 'http://60.160.190.130:8001' + html.xpath(self.url[1] + '[{}]/td[3]/a/@href'.format(i + 1))[0]
                    ...
                    url = 'http://60.160.190.130:8001' + html.xpath(self.url[1] + '[{}]/td[4]/a/@href'.format(i + 1))[0]
                    date_Today = html.xpath(self.url[1] + '[{}]/td[5]/text()'.format(i + 1))[0]
                    if title == '':
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['13003.001', '红塔区'], ['13003.002', '江川县'], ['13003.003', '澄江县'], ['13003.004', '通海县'], ['13003.005', '华宁县'], ['13003.006', '易门县'], ['13003.007', '峨山彝族自治县'], ['13003.008', '新平彝族傣族自治县'], ['13003.009', '元江哈尼族彝族傣族自治县']]
        for i in city_list:
            if i[1] in addr:
                city = float(i[0])
                break
