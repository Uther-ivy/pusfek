...
def get_project(url):
    ...
    resp.encoding='uft8'
    sel = Selector(resp)
    titles = sel.xpath('//div[@class="categorypagingcontent"]/div[1]/ul/li')
    now_time = tool.date
    # now_time = '2021-06-30'
    for ti in titles:
        title = ti.xpath('./a/text()').extract_first().strip()
        info_url = "http://xn.xgsggzy.com" + ti.xpath('./a/@href').extract_first()
...
if __name__ == '__main__':
    ...
    try:
        ...
        url_list = [
            "http://xn.xgsggzy.com/xnweb/jyxx/070001/070001001",
            "http://xn.xgsggzy.com/xnweb/jyxx/070001/070001002",
            "http://xn.xgsggzy.com/xnweb/jyxx/070001/070001003",
            "http://xn.xgsggzy.com/xnweb/jyxx/070001/070001004",
            "http://xn.xgsggzy.com/xnweb/jyxx/070001/070001005",
            "http://xn.xgsggzy.com/xnweb/jyxx/070002/070002001",
            "http://xn.xgsggzy.com/xnweb/jyxx/070002/070002002",
            "http://xn.xgsggzy.com/xnweb/jyxx/070002/070002003",
        ]
        for url in url_list:
            get_project(url)
