...
class wenshan_ggzy:
    def __init__(self):
        self.domain_name = 'http://61.146.213.251'
        self.url_list = [
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['10010.001', '端州区'], ['10010.002', '鼎湖区'], ['10010.003', '广宁县'], ['10010.004', '怀集县'], ['10010.005', '封开县'], ['10010.006', '德庆县'], ['10010.007', '高要'], ['10010.008', '四会']]
