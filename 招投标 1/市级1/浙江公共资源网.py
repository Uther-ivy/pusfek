...
class xinyang_ggzy:
    def __init__(self):
        self.url_list = ['004001', '004002', '004003', '004004', '004005', '004006']
    ...
    def parse(self):
        ...
        while True:
            page += 1
            url_to = 'http://new.zmctc.com/zjgcjy/jyxx/{}/{}00{}/?Paging={}'.format(self.url, self.url, num, page)
            # http://new.zmctc.com/zjgcjy/jyxx/004002/004002001/?Paging=1
            text = tool.requests_get(url_to, self.headers)
            ...
            for li in detail:
                try:
                    ...
                    url = 'http://new.zmctc.com' + li.xpath('./td[2]/a/@href')[0]
                except:
                    continue
