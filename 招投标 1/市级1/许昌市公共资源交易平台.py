...
class xuchang_ggzy:
    ...
    def parse(self):
        ...
        while True:
            ...
            for li in detail:
                ...
                url = 'http://ggzy.xuchang.gov.cn' + li.xpath('./a/@href')[0]
    ...
    def parse_detile(self, title, url, date):
        ...
        detail = url_html.xpath('/html/body/div[10]/div[2]/div')[0]
        detail_html = etree.tostring(detail, method='HTML')
        detail_html = html.unescape(detail_html.decode())
        detail_text = url_html.xpath('string(/html/body/div[10]/div[2]/div)').replace('\xa0', '').replace('\n', '').\
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['8510.001', '魏都区'], ['8510.002', '许昌县'], ['8510.003', '鄢陵县'], ['8510.004', '襄城县'], ['8510.005', '禹州市'], ['8510.006', '长葛市']]
        for i in city_list:
            if i[1] in addr:
                city = float(i[0])
                break
