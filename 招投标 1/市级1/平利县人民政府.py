...
class wenshan_ggzy:
    def __init__(self):
        self.domain_name = 'http://www.pingli.gov.cn'
        self.url_list = [
            'http://www.pingli.gov.cn/govsub/publicinfo/category-4540_{}.html',
            'http://www.pingli.gov.cn/govsub/publicinfo/category-4541_{}.html'
        ]
    ...
    def parse(self):
        ...
        while True:
            ...
            # print(11, text)
            # time.sleep(6666)
            detail = html.xpath('//*[@id="scrollbar1"]/div/div/div/ul/li')
            for li in detail:
    ...
    def parse_detile(self, title, url, date):
        ...
        detail_text = url_html.xpath('string(//*[@id="fontzoom"])').replace('\xa0', '').replace('\n',
                                                                                                             ''). \
            replace('\r', '').replace('\t', '').replace(' ', '').replace('\xa5', '')
