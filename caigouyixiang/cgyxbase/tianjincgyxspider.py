...
class cgyxspider(object):
    ...
    def get_data_detail(self, url):
        ...
        if res:
            ...
            size= detail.xpath("//table[@id='projectBundleList']//tr")
    ...
    def get_data_list(self, times,page):
        ...
        for rank in [2022,2021]:
            ...
            if data_list:
                ...
                all_data = html.xpath("//ul[@class='dataList']/li")
                for num in range(1, len(all_data) + 1):
                    ...
                    if releasetime >= todaytime:
                        title = html.xpath(f"//li[{num}]/a/text()")[0]
                        # articleId = int(str(time.time()*1000)[::3])
                        href = html.xpath(f"//li[{num}]/a/@href")[0]
    ...
    def get_cookie(self):
        ...
        cookie = f"HttpOnly; insert_cookie={cookies['insert_cookie']}; JSESSIONID={cookies['JSESSIONID']}; HttpOnly"
