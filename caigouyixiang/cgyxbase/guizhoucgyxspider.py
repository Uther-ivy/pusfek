...
class cgyxspider(object):
    ...
    def get_data_list(self, times,page):
        ...
        print(url)
        district=["529900",'520100','520200','520300','520400','520500','520600','520800','520900','522300','522600','522700',]
        for discode in district:
            payload ={
                ...
                "pageNo": f"{page}",
                "pageSize": "100",
                "utm": "sites_group_front.2ef5001f.0.0.386559c06a4411ed9f4845cf31232151"
            }
            data=None
...
def run(page,spider,times,file):
    ...
    for lis in spider.get_data_list(times,page):
        ...
        prodict['title'] = title
        detailurl = f'http://www.ccgp-guizhou.gov.cn/front/search/mobile/detail?id={articleId}&timestamp={str(int(time.time()))}'
        prodict['detailurl'] = f'http://www.ccgp-guizhou.gov.cn{href}'
