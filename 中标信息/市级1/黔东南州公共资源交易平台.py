...
class qiandongnan_ggzy:
    ...
    def get_nativeplace(self, addr):
        city = ''
        city_list = [['12508.001', '凯里市'], ['12508.01', '台江县'], ['12508.011', '黎平县'], ['12508.012', '榕江县'], ['12508.013', '从江县'], ['12508.014', '雷山县'], ['12508.015', '麻江县'], ['12508.002', '黄平县'], ['12508.003', '施秉县'], ['12508.004', '三穗县'], ['12508.005', '镇远县'], ['12508.006', '岑巩县'], ['12508.007', '天柱县'], ['12508.008', '锦屏县'], ['12508.009', '剑河县']]
        for i in city_list:
            if i[1] in addr:
                city = float(i[0])
                break
